...
})({"c4wWQ":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = true;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "dc87ca7cc738958f";
"use strict";
...
$(document).ready(function() {
    ...
    $(".scoreList").click((e)=>{
        ...
        //
        (0, _configJs.displayLines)(e.target.id);
    });
    // PLAYER DISPLAY
...
const playersRunDetails = (_playerId)=>{
    $.ajax({
        ...
        success: function(res) {
            const _resData = res;
            console.log(_resData);
            (0, _configJs.displayRunMesh)(_resData); // INSIDE CONFIQ.JS
            (0, _configJs.wagonWheel)(_resData);
        }
    });
};
...
},{"./config.js":"k5Hzs"}]},["c4wWQ","efi6n"], "efi6n", "parcelRequire3a24")

//# sourceMappingURL=index.c738958f.js.map
